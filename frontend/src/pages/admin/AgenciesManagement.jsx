...
function AgenciesManagement() {
  const agencies = [
    {
      id: 1,
      name: "Rentivo Fès Centre",
      city: "Fès",
      address: "Avenue Hassan II",
      phone: "+212 6 12 34 56 78",
      email: "fes@rentivo.com",
      manager: "Yassine Alami",
    },

    {
      id: 2,
      name: "Rentivo Casablanca",
      city: "Casablanca",
      address: "Maarif Center",
      phone: "+212 6 88 77 66 55",
      email: "casa@rentivo.com",
      manager: "Sara Bennani",
    },
          ...
          {agencies.map((agency) => (
            ...
            >
              ...
              <div className="mt-6 space-y-4">
                <Info
                  icon={<MapPin size={16} />}
                  text={`${agency.city} - ${agency.address}`}
                />
